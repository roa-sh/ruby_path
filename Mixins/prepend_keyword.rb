# prepend makes an include but with priority, it places the module first than the method itself
# prepend = .ancstors [Purchaseable, Bookstore, Object, Kernel, BasicObject]
# include = .ancstors [Bookstore, Purchaseable, Object, Kernel, BasicObject]
